...
if prediksi[0] == 1:
    st.write("Pasien positif diabetes")
else:
    st.write("Pasien negatif diabetes")
st.write(status_diabetes[prediksi])

st.subheader('Kemungkinan Hasil yang Diprediksi')
if prediksi[0] == 1:
    st.write("Hasil Probabilitas Positif Diabetes")
else:
    st.write("Hasil Probabilitas Negatif Diabetes")
